    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" value="<?= $book['title'] ?? '' ?>" class="form-control"
                   id="exampleInputPassword1" placeholder="Titre">
        </div>
        <div class="form-group">
            ...
            <input type="text" name="author" value="<?= $book['author'] ?? '' ?>" class="form-control"
                   id="exampleInputPassword1" placeholder="Auteur">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1" class="form-label mt-4">Prix</label>
            <input type="number" value="<?= $book['price'] ?? '' ?>" step="any" name="price" class="form-control"
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="resume" id="exampleTextarea"
                      rows="3"><?= $book['resume'] ?? '' ?></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="publish_date" value="<?= $book['publish_date'] ?? '' ?>" type="date"
                   id="formFile">
        </div>
